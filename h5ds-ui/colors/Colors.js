    ...
    <div className={classNames('ui-colors', className)}>
      {colorList.map((d, i) => {
        return (
          ...
          >
            <span className="ui-colors-iteminner" style={{ backgroundColor: d, border: `1px solid rgba(0,0,0,0.1)` }}>
      ...
      {!noAdd && (
        <Popover
          ...
          <span
            ...
            style={{ backgroundColor: 'rgba(0,0,0,1)', border: `1px solid rgba(0,0,0,0.1)` }}
          >
            +
          </span>
        </Popover>
